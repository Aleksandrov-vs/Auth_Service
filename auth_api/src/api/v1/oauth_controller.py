...
def authorize():
    oauth_service = get_oauth_service(oauth_rep.get_oauth_repository(), token_rep.get_token_repository())
    ...
    status, result = oauth_service.login_or_create_social(social_id, user_login, user_agent)
